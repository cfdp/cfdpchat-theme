...
(function ($) {
  ...
  $(function () {
    ...
    var copyTextBusy = "<p>Velkommen til KRAM-gruppechat.</p><p>Chatten er optaget.</p>";
    var copyTextClosed = "<p>Velkommen til KRAM-gruppechat.</p><p> &Aring;bningstider:</p><ul><li>Mandag 18-21</li></ul>";
    ...
    var updateDisplay = function (attributes) {
      ...
      if (chatStatus.chatOpen && chatStatus.roomsList && chatStatus.roomsList.length && chatStatus.rooms.group.full == 0) {
        ...
        statusInfo.html('<p>Velkommen til KRAM-gruppechat.</p>');
      }
